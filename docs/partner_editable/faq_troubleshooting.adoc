...
*A.* If your DRAGEN job fails, more information will be available in Amazon CloudWatch Logs. You can access the log either from the CloudWatch console (see Figure 7) or through the *Log stream name* link in the AWS Batch job (see Figure 8).
